...
export default async function Page() {
  ...
  const toc = [
    ...
    },
    {
      label: "GOVERNING LAW",
      content: [
        "These Legal Terms shall be governed by and defined following the laws of The United States of America. BayView Development and yourself irrevocably consent that the courts of The state of Nevada shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these Legal Terms.",
      ],
    },
    {
  ...
  const contact_email = "contact@bayview.dev";
  ...
  return (
    <>
      ...
      <p className="p-4">
        We are BayView Development ( &quot;<b>Company,</b>&quot; &quot;
        <b>we,</b>
        &quot; &quot;<b>us,</b>&quot; &quot;<b>our</b>&quot; ).
      </p>
      ...
      <p className="p-4 pt-0">
        You can contact us by email at contact@bayview.dev.
      </p>
      <p className="p-4 pt-0">
        These Legal Terms constitute a legally binding agreement made
        between you, whether personally or on behalf of an entity
        (&quot;you&quot;), and BayView Development, concerning your access
      ...
      <section>
        <ol className="list-decimal pl-8 pr-8">
          {toc.map((item, i) => (
            <li key={i}>
              <span
                className="!bold text-xl"
                id={`${item.label.toLocaleLowerCase().replace(/ /, "-")}`}
              >
                <b>{item.label}</b>
              </span>
              {item.content.length <= 3 ? (
                <>
                  {item.content.map((content, i) => (
                    <p className={"p-4" + (i <= 0 ? "" : " pt-0")} key={i}>
                      {content}
                    </p>
                  ))}
                </>
              ...
              {item.content?.length === 1 ? (
                <p className="p-4">{item.content[0]}</p>
              ) : item.content.length === 2 ? (
                <>
                  <p className="p-4">{item.content[0]}</p>
                  <p className="p-4 pt-0">{item.content[1]}</p>
                </>
              ) : item.content.length === 3 ? (
                <>
                  <p className="p-4">{item.content[0]}</p>
                  <p className="p-4 pt-0">{item.content[1]}</p>
                  <p className="p-4 pt-0">{item.content[2]}</p>
                </>
              ) : item.label === "INTELLECTUAL PROPERTY RIGHTS" ? (
                <>
                  <h2 className="mt-4">
                    <b className="text-lg">Our intellectual property</b>
                  </h2>
                  <p className="p-4">
                  ...
                  <h2>
                    <b className="text-lg">Your use of our Services</b>
                  </h2>
                  <p className="p-4">
                  ...
                  <ol className="list-disc pl-12 m-2 mt-0">
                  ...
                  <p className="p-4 pt-0">
                    ...
                    {contact_email}. If we ever grant you the permission to
                    post, reproduce, or publicly display any part of our
                    Services or Content, you must identify us as the owners
                    or licensors of the Services, Content, or Marks and
                    ensure that any copyright or proprietary notice appears
                    or is visible on posting, reproducing, or displaying our
                    Content.
                  </p>
                  <p className="p-4 pt-0">
                  ...
                  <h2>
                    <b className="text-lg">Your submissions</b>
                  </h2>
                  <p className="p-4">
                  ...
                  <ol className="list-disc pl-12 mt-0 m-2">
                    <li>
              ...
              ) : item.label === "DISPUTE RESOLUTION" ? (
                <>
                  <h2 className="p-4 pb-1">
                    <b>Informal Negotiations</b>
                  </h2>

                  <p className="p-4 pt-1 pl-8 pr-8">
                  ...
                  <p className="p-4 pt-1 pl-8 pr-8">
                    ...
                    it, is considered as the part of this clause.
                  </p>
                ...
                <>
                  ...
                  <ol className="list-disc pl-12 pr-12 mb-4">
